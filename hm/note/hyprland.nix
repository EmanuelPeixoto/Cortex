  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      window_rule = [
        ...
        {
          match = {
            class = "^(com\.gabm\.satty|satty|ksnip)$";
          };
          float = true;
        }
        {
      ...
      ++ [
        ...
        # === media keys (noctalia) ===
        {
          _args = [
            ...
            (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"${noct} volume-down\")")
            {
              locked = true;
              repeating = true;
            }
        ...
        (mkCmd "XF86AudioStop" "${noct} media toggle")
        {
          _args = [
            ...
            (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"${noct} volume-up\")")
            {
              locked = true;
              repeating = true;
            }
        ...
        }
        {
          _args = [
            ...
            (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"${noct} brightness-down\")")
            {
              locked = true;
              repeating = true;
            }
        ...
        }
        {
          _args = [
            "XF86MonBrightnessUp"
            (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"${noct} brightness-up\")")
            {
              locked = true;
              repeating = true;
            }
